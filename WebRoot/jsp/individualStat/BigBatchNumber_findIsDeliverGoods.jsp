	...
	<body>
  	...
  	<div style="width:100%;height:100%;text-align: center;background: #dddddd;">
		...
		<%
		 ...
		 %>
		<div style="font-size: 14px;">当前位置&nbsp;>&nbsp;查询统计&nbsp;>&nbsp;发货查询</div>

		<hr/>
		<form action="BigBatchNumber!selectIsDeliverGoods.action" method="post" id="myform">
			<div class="saixuan">
				发货状态：
			...
			<div>
				<table  cellpadding="1" cellspacing="1" >
					...
					%>
						...
						<tr>					
							<td>
								<a href="SmallnessBatchNumber!selectIsDeliverByBig.action?bigBatchNumberId=<%=b.getId() %>">
		...
		<div>
				<table  cellpadding="1" cellspacing="1" >
					...
					<tr>
						<td>
							<a href="SmallnessBatchNumber!selectIsDeliverByBig.action?bigBatchNumberId=<%=smallBatch.getBigBatchNumber().getId()%>">
