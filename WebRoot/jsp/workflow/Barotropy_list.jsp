...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
		<div style="font-size: 14px;">当前位置&nbsp;>&nbsp;<a href="WorkFlow!list.action?flowTypeId=4">正压流程</a></div>
...
&nbsp;&nbsp;&nbsp;&nbsp;
		...
		<div>
			<table  cellpadding="1" cellspacing="1"  >
				<tr class="th">
					<td>
						<input type="checkbox" name="chkAll" id="chkAll"  style="width: 25px;height:25px;" onclick="setChkboxStatus('smallnessBatchNumberIds')"/>
					</td>
					<td>
						大批号
					</td>
				 ...
				 %>
					<tr>
						<td>
							...
							%>
								<input name="smallnessBatchNumberIds" type="checkbox" disabled="disabled"
											value="<%=w.getSmallnessBatchNumber().getId() %>"  style="width: 25px;height:25px;"
