...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
		<div style="font-size: 14px;">当前位置&nbsp;>&nbsp;<a href="WorkFlow!list.action?flowTypeId=6">打码流程</a></div>
		...
		<div class="saixuan">
				...
				<select name="machine" id="machine"> 
					<option value="0">--请选择--</option>
					<option value="1">一号机</option>
					<option value="2">二号机</option>
					<option value="3">三号机</option>
					<option value="4">四号机</option>
				</select>
				&nbsp;&nbsp;&nbsp;&nbsp;
			获取数量（批）：
