				...
				<tr>
					...
					<td style="font-size: 32px;">
						<s:if test="#numberPlate.numberPlateType.id == 1 || #numberPlate.numberPlateType.id==2 || #numberPlate.numberPlateType.id==3">
							<strong><s:property value="#numberPlate.licensePlateNumber" /></strong>
						</s:if>
						<s:elseif test="#numberPlate.numberPlateType.typeName.indexOf('摩托车')">
							<I><s:property value="#numberPlate.licensePlateNumber" /></I>
						</s:elseif>
						<s:else>
